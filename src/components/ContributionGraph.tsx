...
interface ContributionGraphProps { habits: Habit[]; checkIns: HabitCheckIn[]; onSelectDay: (date: string) => void; }
export function ContributionGraph({ habits, checkIns, onSelectDay }: ContributionGraphProps) {
